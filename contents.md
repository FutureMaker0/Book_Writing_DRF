...
### 알아두면 유용한 DRF 관련 사항들
#### django-filter
장고의 Template을 개발할 때, 데이터 검색 기능을 손쉽게 개발 가능하게 해주는 라이브러리입니다. 뿐만 아니라 DRF와 연계하여 검색 API를 만들고자 할 경우 검색 조건을 또한 개발할 수 있도록 해줍니다.

#### django-extensions
장고 익스텐션을 사용하게 되면 많은 편의성을 제공받을 수 있는 라이브러리입니다.
